  ...
  return(
    <section className={s.section}>
      <form className={s.form + ' ' + s.registerForm}>
        ...
        <label className={s.label}>
          <input type="text" placeholder="Учубное заведение" className={s.input} />
          <p className={s.error}></p>
        </label>
        <label className={s.label}>
        ...
        <label className={s.label}>
          <input type="text" placeholder="Ссылка на аватар"className={s.input} />
          <p className={s.error}></p>
        </label>
        <label className={s.label}>
          <input type="text" placeholder="Адрес электронной почты" className={s.input} />
          <p className={s.error}></p>
        </label>
        <label className={s.label}>
